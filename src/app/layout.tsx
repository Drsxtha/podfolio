...
export const metadata: Metadata = {
    title: 'Dilip Raj Shrestha | Developer Portfolio',
    description: 'hi, I am Dilip Raj Shrestha, a passionate developer specializing in building web applications using Next.js, React, and TypeScript. Welcome to my portfolio website where I showcase my projects and skills.',
    icons: {
