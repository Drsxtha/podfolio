...
export const metadata: Metadata = {
  ...
  description:
    "Hi, I am Dilip Raj Shrestha, a passionate developer specializing in building web applications using Next.js, React, and TypeScript. Welcome to my portfolio website where I showcase my projects and skills.",
  icons: {
